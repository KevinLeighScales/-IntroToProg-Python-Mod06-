...
# Kevin Scales,2/22/2021,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class IO:
    ...
    def input_press_to_continue(optional_message=''):
        ...
        print() # KLS chose to add an extra line for looks though not assigned

    @staticmethod
    def input_new_task_and_priority(lstTable):
        ...
        for row in lstTable:
            if task == row["Task"]:
                print("\nThat task has already been prioritized as a ", row["Priority"])
                discon = 1
                continue
        if discon != 1:
    ...
    @staticmethod
    def input_task_to_remove(lstTable):
        pass  # TODO: Add Code Here!
...
while(True):
    ...
    if strChoice.strip() == '1':  # Add a new Task
        ...
        task, priority = IO.input_new_task_and_priority(lstTable)
        ...
        # TODO: Add Code Here
        task = IO.input_task_to_remove(lstTable)
